...
nearby_search:function(){
  ...
  qqmapsdk.search({
     keyword: text,  //搜索关键词
     location: '30.830332,104.182921',  //设置周边搜索中心点
 ...
 //点击地点进行路径规划
  ...
  test:function(){
    ...
    let key = 'C4MBZ-SY66S-MLLOU-6YQYH-HKNIO-UKF6Z';  //使用在腾讯位置服务申请的key
    let referer = '西柚航仔';   //调用插件的app的名称
    let endPoint = JSON.stringify({  //终点
        'name': '西南石油大学',
        'latitude': 30.826478737996272,
        'longitude': 104.18446172688292
    });
    wx.navigateTo({
  ...
  onLoad: function (options) {
    wx.stopPullDownRefresh() //刷新完成后停止下拉刷新动效
        ...
        qqmapsdk = new QQMapWX({
          key: 'C4MBZ-SY66S-MLLOU-6YQYH-HKNIO-UKF6Z'
      });
      // wx.showModal({
      //   title:'提示',
      ...
      wx.getLocation({
        ...
        success:function(res)
        {
          ...
          if((nowlatitude > 30.8) && (nowlatitude < 30.99) && (nowlongitude > 104.1) && (nowlongitude < 104.25))
          {
            that.setData({
              markers:[
                {
  ...
  modalconfirm:function(e)
  {
    ...
    var key = 'C4MBZ-SY66S-MLLOU-6YQYH-HKNIO-UKF6Z';  //使用在腾讯位置服务申请的key
    var referer = '西柚航仔';   //调用插件的app的名称
